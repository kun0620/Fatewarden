...
export function DiceRoller({ character, onRoll }: DiceRollerProps) {
  ...
  return (
    <section className="fw-panel fw-dice">
      <div
        className={`fw-card fw-dice__result ${rolling ? 'fw-die-shake' : ''}`}
        style={{
      ...
      >
        ...
        <div className="fw-display fw-dice__result-value">
          {lastRoll ? lastRoll.total : '--'}
          <span className="fw-dice__result-mod">
      ...
      <div className="fw-dice__controls">
      ...
      <section className="fw-card fw-dice__quick" style={{ background: 'var(--surface-2)' }}>
        <div className="fw-dice__quick-head">
        ...
        <div className="fw-dice__quick-grid">
          {quickDice.map((die) => (
            <button
      ...
      <section className="fw-card fw-dice__saved" style={{ background: 'var(--surface)' }}>
      ...
      <section className="fw-card fw-dice__history" style={{ background: 'var(--surface-2)' }}>
